...
// https://github.com/processing/p5.js/blob/3754ce63deab32842fd81c393c62ff9e388f8637/src/math/noise.js

import { rand } from './math.utils';

const _p_fixed: number[] = [
...
const _p_random: number[] = Array.from({ length: 256 }, () => rand(0, 255));
const _p: number[] = _p_random || _p_fixed;
